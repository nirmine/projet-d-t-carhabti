...
<aside>
  <div id="sidebar" class="nav-collapse ">
    ...
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Ajouter un fonctionnaire</h3>
        <div class="row" id="vidange">
          
          <!-- /col-md-12 -->
          <div class="col-md-12 mt">
            <div class="content-panel">
            <form  action="ajout_fonct1.php" name="form1" method="POST" enctype="multipart/form-data" onsubmit="ajout_fonct(document.form1.nom,document.form1.prenom,document.form1.cin,document.form1.adresse,document.form1.tel,document.form1.pwd);" >
                <div class="form-group">
                    <div>
                <input type="text" name="nom" id="nom" class="form-control round-form"  placeholder="Nom"> 
                </div>
                <div>
                <input type="text" name="prenom" id="prenom" class="form-control round-form"  placeholder="Prénom"> 
                </div>
                <div>
                <input type="number" name="cin" id="cin" class="form-control round-form" maxlength="8" placeholder="NCIN"> 
                </div>
                <div>
                <input type="text" name="adresse" id="adresse" class="form-control round-form" placeholder="Adresse">
                </div>
                <div>
                <input type="number" name="tel" id="tel" class="form-control round-form" maxlength="8" placeholder="Numéro de télèphone">
                </div>  
                <div>
                <input type="text" name="pwd" id="pwd" class="form-control round-form" placeholder="Password"> 
                </div>
                <div class="form-group last">

                        <input type="file" name="fonct_img" class="default"  />

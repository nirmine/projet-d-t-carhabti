...
{   $i++;
    ...
    <a class=\"btn btn-primary btn-xs\" href=\"modifierReservation.php?numRes=".$reponse1['numero_reservation']."\"><i class=\"fa fa-pencil\"></i></a>
    <a class=\"btn btn-danger btn-xs\" href=\"listeReservations.php?numReser=".$reponse1['numero_reservation']."\"><i class=\"fa fa-trash-o\"></i></a></td>
     </tr>";
  else
  ...
  <td class=\"center hidden-phone\">".$reponse1['montant_paye']."</td>
  <td class=\"center hidden-phone\"><a class=\"btn btn-success btn-xs\" href=\"contrat.php?numRes=".$reponse1['numero_reservation']."\"><i class=\" fa fa-check\"></i></a>
    <a class=\"btn btn-primary btn-xs\" href=\"modifierReservation.php?numReservation=".$reponse1['numero_reservation']."\"><i class=\"fa fa-pencil\"></i></a>
    <a class=\"btn btn-danger btn-xs\" href=\"listeReservations.php?numReser=".$reponse1['numero_reservation']."\"><i class=\"fa fa-trash-o\"></i></a></td>
     </tr>";

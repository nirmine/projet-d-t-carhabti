  ...
  <section id="container">
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <form  action="nouvelleReservation.php" method="POST" class="form-horizontal style-form" name="ajoutRes" onsubmit=" javascript: return nouvRes(document.ajoutRes.cin1,document.ajoutRes.cin2,document.ajoutRes.permis2,document.ajoutRes.tel2,document.ajoutRes.montant_payé,document.ajoutRes.numeroPaiement);">
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="accueilFonct.php#" class="go-top">

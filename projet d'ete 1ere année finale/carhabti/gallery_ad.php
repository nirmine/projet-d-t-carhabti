...
<aside>
  <div id="sidebar" class="nav-collapse ">
    ...
    die('Erreur : ' . $e->getMessage());
     ...
     $rep=$db->query('SELECT numero_vehicule , img_voiture,serie,enregistrement FROM vehicule');
     ...
     while($e=$rep->fetch())
     {
       /*  echo "  
                 ...
                 <div class=\"photo\">
                   <a class=\"fancybox\" href=\"gallery_trait.php?num=".$e['numero_vehicule']."\"><img class=\"img-responsive\" src=\"photoVoiture\\".$e['img_voiture']." \" alt=\"\"></a>
       ...
       <div class=\"thumbnail\">
         ...
         <div class=\"caption\">
           ...
           <p><a href=\"gallery_trait.php?num=".$e['numero_vehicule']." \"  class=\"btn btn-primary\" role=\"button\"> Voir Fiche Voiture </a></p>
         </div>
       </div>
     </div>
       ";

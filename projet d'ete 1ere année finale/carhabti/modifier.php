    ...
    <section class="wrapper site-min-height">
       ...
       <div class="col-lg-12">
         <div class="form-panel">
           <h4 class="mb"><i class="fa fa-angle-right"></i> Modifier les données d'une vehicule</h4>
           <form  action="modifier1.php" method="POST"  name="form1" onsubmit="javascript : return modif_v(document.form1.serie,document.form1.enregistrement);">
             <div class="form-group">
               <div>
               <label class="control-label col-md-3">Série</label> 
                 <input type="number" name="serie" id="serie" class="form-control round-form" placeholder="Série" minlength="2" maxlength="3" required>
               </div>
               <div>
               <label class="control-label col-md-3">Enregistrement</label> 
                 ...
                 <div>
                 <div>
                    <label class="control-label col-md-3">Modèle de la voiture</label> 
                    <input type="text" name="model" id="model"class="form-control round-form" placeholder="Modèle" required>
                 </div>
                 <label class="control-label col-md-3">Choisissez le critère que vous voulez modifier</label> 
                 <select name="modif" id="modif" class="form-control round-form">
                     ...
                     <option value="kilometrage">Kilomètrage</option>
...
<footer class="site-footer">
  <div class="text-center">
    ...
    <a href="modifier.php#" class="go-top">
...
function modif_v(v1,v2)  //validation des données du formulaire de modification des données d'une voiture
{
    ...
    {
        alert("verifier la série de voiture saisie");
        return false;
    }

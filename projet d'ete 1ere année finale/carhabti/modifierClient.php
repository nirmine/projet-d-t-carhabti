...
<head>
  ...
  <title>Carhabti-Modifier Coordonnées client</title>
            ...
            <div class="col-lg-12">
              <div class="col-lg-12">
                ...
                <div class="form-panel">
                  <div class=" form">
                    <form class="cmxform form-horizontal style-form" action="<?php echo"modifierClientSup.php?numCli=".$_GET['numCli']."&stat=fonct"?>" id="commentForm" name="form4" method="POST" onsubmit="javascript: return ajout_client(document.form4.cin,document.form4.numPermis,document.form4.tel,document.form4.mail);" >

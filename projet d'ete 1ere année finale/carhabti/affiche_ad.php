    ...
    <h3><i class="fa fa-angle-right"></i> Afficher les piéces reparés pour une voiture donnée</h3>
       ...
       <div class="col-lg-12">
         <div class="form-panel">
           ...
           <form  action="affiche1_ad.php" method="POST"  name="form1" onsubmit="javascript : return affiche(document.form1.sr,document.form1.enreg);">
             <div class="form-group">

                 <div>
                     <input type="text" name="sr" class="form-control round-form" placeholder="Série" maxlength="3" minlength="2"> 
                 </div>
                 <div>
...
<footer class="site-footer" style="margin-top:350px">
  <div class="text-center">
    ...
    <a href="affiche_ad.html#" class="go-top">

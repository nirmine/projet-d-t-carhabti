...
<body>
  <section id="container">
        ...
        <p class="centered"> <?php echo " <img src=\"photoFonct/". $_SESSION['image'] ."\" class=\"img-circle\" style=\" width:100px;height:100px; \">" ;?></p>
          ...
          <li class="sub-menu">
           ...
           <li><a   href="affiche_fonct.php">Affiche fonctionnaire</a> </li> <!-- Afficher la fiche d'un fonctionnaire -->
            ...
            <li><a href="modif_fonct">Modifier des données</a></li><!-- mise à jour de l'état de présence du fonctionnaire -->
    ...
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Supprimer un Fonctionnaire</h3>
        <div class="row" id="vidange">
          ...
          <div class="col-md-12 mt">
           ...
           <form  action="sup_fonct1.php" method="POST"  name="form1" onsubmit="javascript: return verif_pos(document.form1.cin.value);">
             <div class="form-group">
             <div class="col-sm-10"> 
                     <input type="number" name="cin" class="form-control round-form" maxlength="8"  minlength="8" placeholder="NCIN" required> 
               </div>
               <div>
                 <input type="submit" value="Supprimer" class="btn btn-round btn-success" >
               </div>
             </div>
           </form>
    ...
    <!--main content end-->
    <!--footer start-->
    <footer class="site-footer" style="margin-top:460px">
...
function verif_pos(num)   //verifier si une entrée est un entier et et positif
{
   ...
   alert("Vérifier le Numéro de CIN saisie ");
   return false;
}
</script>

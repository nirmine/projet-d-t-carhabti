...
<head>
  ...
  <title>Carhabti-Liste Client</title>
                    ...
                    <table class="table table-hover" style="text-align:center">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style="text-align:center"><i class="fa fa-bookmark"></i> Nom & Prénom</th>
                          
                          <th style="text-align:center"><i class="fa fa-bullhorn"></i> Télèphone</th>
                          <th style="text-align:center"><i class=" fa fa-edit"></i>Mail</th>
                          <th style="text-align:center"><i class="fa fa-question-circle"></i> Plus D'infos </th>
                          <th style="text-align:center"><i class="fa fa-question-circle"></i>Modification </th>                        
                        </tr>
                      </thead>
                      <tbody>
                      <?php

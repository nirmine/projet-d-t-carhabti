  ...
  <section id="container">
    ...
    <section class="wrapper site-min-height">
       ...
       <hr>
          ...
          <table class="table table-hover" style="text-align:center;margin-bottom:60px">
              <h4 class="mb" style="margin-bottom:40px"><i class="fa fa-angle-right"></i> Les données de la voiture</h4>
       ...
       affichecaracteristique("fonctionnaire");
...
<footer class="site-footer">
  <div class="text-center">
    ...
    <a href="affiche1.php#" class="go-top">

   ...
   <!--sidebar end-->
                  ...
                  <table class="table table-hover" style="text-align:center">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style="text-align:center"><i class="fa fa-question-circle"></i> Suppression/Modification </th>
                        </tr>
                      </thead>
                      <tbody>
                      <?php
    ...
    <footer class="site-footer">
      <div class="text-center">
        ...
        <a href="listeClient_ad.php#" class="go-top">

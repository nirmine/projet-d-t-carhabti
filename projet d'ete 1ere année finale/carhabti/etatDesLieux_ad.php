...
<body>
        ...
        <p class="centered"> <?php echo " <img src=\"photoFonct/". $_SESSION['image'] ."\" class=\"img-circle\" style=\" width:100px;height:100px; \">" ;?></p>
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <li> <a href="disponible_ad.php">Disponibilités & Reservations</a> </li>  
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Etat Des Lieux à la remise du voiture</h3>
        <!-- BASIC FORM ELELEMNTS -->
        <form class="form-horizontal style-form" method="post" name="form1" action="intermediaire_ad.php" onsubmit="javascript: return etat(document.form1.kilometrageRetour,document.form1.niveauCarburant,document.form1.nbrEraflure,document.form1.placeEraflure,document.form1.prixEraflure,document.form1.nbrBosse,document.form1.placeBosse,document.form1.prixBosse,document.form1.nbrManque,document.form1.placeManque,document.form1.prixManque,document.form1.fautif,document.form1.manquePapiers);">
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Consommation</h4>
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kilométrage Retour :</label>
                  <div class="col-sm-10">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Etat Véhicule </h4>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i>Papiers et documents :</h4>
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Manque des papiers à la remise ? :</label>
                  <div class="col-sm-10">
  ...
  function verif_pos(num)   //verifier si une entrée est un entier et et positif
{
  ...
  function etat(kilometrage,nEraflure,prixEraflure,nBosse,prixBosse,nManque,prixManque)
  {
    ...
    {
      alert("Vérifier le kilomètrage de Retour saisie");
      return false;
    }
    if(nEraflure.value<0)
    {
      alert("Vérifier le nombre de pièce qui ont une panne de type Eraflures saisies");
      return false;
    }
    if(nBosse.value<0)
    {
      alert("Vérifier le nombre de pièce qui ont une panne de type Bosse saisies");
      return false;
    }
    if(verif_pos(nManque.value)<0)
    {
      alert("Vérifier le nombre de pièce qui ont une panne de type Manque saisie");
      return false;
    }
    if((prixManque.value!=NAN)&&(!(verif_pos(prixManque.value))))
    {
      alert("Vérifier le prix de réparation des pièce qui ont une panne de type Manque saisie");
      return false;
    }
    if((prixBosse.value!=NAN)&&(!(verif_pos(prixBosse.value))))
    {
      alert("Vérifier le prix de réparation des pièce qui ont une panne de type Bosse saisie");
      return false;
    }
    if((prixEraflure.value!=NAN)&&(!(verif_pos(prixEraflure.value))))
    {
      alert("Vérifier le prix de réparation des pièce qui ont une panne de type Eraflure saisie");
      return false;
    }
    else
    {

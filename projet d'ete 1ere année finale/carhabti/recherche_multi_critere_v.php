  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <div class="nav notify-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          <!-- settings start -->
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="accueilFonct.php">
    ...
    <aside>
      ...
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Recherche Multi Critère</h3>
       
          <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Rechercher</h4>
              <form  action="recherche.php" method="POST"  name="form1">
            
              <div class="form-group">
                  <label for="rech" class="sr-only">Choisissez le critère de recherche </label>
                    <select name="rech" id="rech" class="form-control round-form">
                        <option value="marque">Marque</option>
                        <option value="carburant">carburant</option>
                        <option value="categorie">categorie</option>
                        <option value="couleur">Couleur</option>
                        <option value="immatriculation">Immatriculation (Sous la forme:)</option>
                 ...
                 <div class="form-group">
                    <label for="mark" class="sr-only" >Donnez une valeur</label>   <br>
                    <div class="col-sm-10"> 
                        <input type="text" name="mark" id="mark" class="form-control round-form" required> 
                    </div>
                 </div>
                 <div>
    ...
    <footer class="site-footer" >
      <div class="text-center">
        ...
        <a href="recherche_multi_critere_v.php#" class="go-top">

...
<body>
  <section id="container">
    ...
    <h3><i class="fa fa-angle-right"></i> Gestion des absences</h3>
    <hr>
    <div class="container">
                    <div class="col-md-12">
                        ...
                        echo" <li class=\"col-sm-4 col-xs-12 portfolio-item nopadding-lr apps isotope-item\" style=\" width:370px;height:370px; margin-top:50px\">
                                ...
                                <img src=\"photoFonct/".$e['img_fonct']. " \" class=\"img-responsive smoothie \" alt=\" \">
                                    ...
                                    <div class=\"hover-item-caption smoothie\">
                                        ...
                                        <br> <br> <br> <br> <br>
                                            ...
                                            <a href=\"absent.php?cin=".$e['ncin'] ." \" title=\"View Gallery\" class=\"btn btn-primary lb-link smoothie\">Absent</a>
                                            <a href=\"present.php?cin=".$e['ncin'] ." \" class=\"smoothie btn btn-primary\">Présent</a>
                                        </div>
                                    </div>
                                </div>
                            </li> ";

           ...
           <form  action="modifier1_ad.php" method="POST"  name="form1" onsubmit="javascript : return modif_v(document.form1.serie,document.form1.enregistrement);">
             <div class="form-group">
               ...
               <label class="control-label col-md-3">Série</label> 
                 <input type="number" name="serie" id="serie" class="form-control round-form" placeholder="Série" maxlength="3" minlength="2" required>
               </div>
               <div>
...
function modif_v(v1,v2)  //validation des données du formulaire de modéfication des données d'une voiture
{

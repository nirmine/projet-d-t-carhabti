    ...
    <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Recherche Fonctionnaire</h4>
                 <form name="form3" method="POST"  action="rech_fonct_trait.php" onsubmit="javascript:return verif_pos(document.form3.cin.value);">           
                    <div class="form-group"> 
                        <input type="text" name="nom" id="nom"  class="form-control round-form" placeholder="Nom:" required> 
                        <input type="text" name="prenom" id="prenom"  class="form-control round-form" placeholder="Prénom:" required>
                        <input type="number" name="cin" id="cin"  class="form-control round-form" minlength="8" maxlength="8" placeholder="Numéro de CIN :" required>
                        <div>
                                 <input type="submit" value="rechercher"  class="btn btn-round btn-success"> 
                            </div>
                    </div>
                 </form>
            </div>
...
<footer class="site-footer">
  <div class="text-center">
    ...
    <a href="rech_fonct.php#" class="go-top">

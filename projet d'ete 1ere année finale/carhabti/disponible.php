...
<body>
  <section id="container">
    ...
    <h3><i class="fa fa-angle-right"></i> Disponibilité </h3>
       ...
       <div class="col-lg-12">
         <div class="form-panel">
           <h4 class="mb"><i class="fa fa-angle-right"></i> Disponibilité dans un intervalle de date </h4>
           <form  action="disponible2.php" method="POST"  id="form2" name="form2" onsubmit="javascript : return compare_d(document.form2.date3,document.form2.date4);" >
              <div class="form-group">
               <div>
                ...
                <div>
                    <label for="date2" class="sr-only" >Choisissez une date de réstitution</label> <br>
       ...
       <div class="col-lg-12">
         <div class="form-panel">
           <h4 class="mb"><i class="fa fa-angle-right"></i> Disponibilité d'une voiture dans un intervalle de date </h4>
              ...
              <div class="form-group">
               <div>
                ...
                <div>
                    ...
                    <input type="datetime-local" name="date2" id="date2" class="form-control round-form" placeholder="Choisissez une date de réstitution" > 

                </div>
                <div>
                    <br>
                <input type="text" name="model" id="model" class="form-control round-form" placeholder="Modèle de la voiture" required> 
                </div>
                <div>
                    <br>
...
if(date1>date2)
{  
    alert("Veuillez vérifier que la deuxiéme date est supérieur à la premiére!!");
    return false;
}
else
{  

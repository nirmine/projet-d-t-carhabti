...
<body>
  <section id="container">
    ...
    <section class="wrapper">
           <h4 class="mb"><i class="fa fa-angle-right"></i> Fiche Fonctionnaire </h4>
                <?php 
                  try
                  {
                  ...
                  die('Erreur : ' . $e->getMessage());
                   ...
                   $r=$db->prepare('SELECT * FROM fonctionnaire WHERE ncin=?');
                   $r->execute(array($_GET['cin']));
                   while($e=$r->fetch())
                   {
                     echo " <div class=\"row\">
                      <div class=\"col-lg-12\">
                        ...
                        <div class=\"col-lg-4 col-md-4 col-sm-4 col-xs-12\" style=\" width:1300px;height:2000px; \">
                          <div class=\"custom-box\">
                            ...
                            <ul class=\"pricing\">
                              ...
                              <li>".$e['presence']."</li>
                              <li>Nombre de jours travaillés:
                             ".$e["nb_jour_travail"]."</li>

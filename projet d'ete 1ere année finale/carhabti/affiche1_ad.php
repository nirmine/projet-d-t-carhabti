...
<body>
  <section id="container">
    ...
    <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Affichage</h3>
       <hr>
          <div class="row mt">
          <div class="col-lg-12"style="background-color: white;">
          <table class="table table-hover" style="text-align:center;">
              <h4 class="mb" style="margin-bottom:100px"><i class="fa fa-angle-right"></i> Les données de la voiture</h4>
     
              <thead>
                  <tr>
                    
                    <th style="text-align:center">Num d'Immatriculation</th>
                    <th style="text-align:center">Modèle</th>
                    <th style="text-align:center">Couleur</th>
                    <th style="text-align:center">Date de visite Technique</th>
               ...
               include("affiche_donnee_voiture_panne.php");
               affichecaracteristique("administrateur");
...
<footer class="site-footer">
  <div class="text-center">
    ...
    <a href="affiche1_ad.php#" class="go-top">

...
<head>
  ...
  <title>CARHABTI-liste des réservations</title>
  ...
  <section id="container">
        ...
        <p class="centered"><?php echo " <img src=\"photoFonct/". $_SESSION['image'] ." \" class=\"img-circle\" width=\"80\">" ;?></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li> <a href="disponible.php">Nouvemle Reservation</a> </li>  
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <h3><i class="fa fa-angle-right"></i>Listes Des réservations</h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">Prise en charge/Modification/Suppression</th>
                  </tr>
                </thead>
                <tbody>
                  <?php include('listeReservationsSup.php'); ?>
                  
                </tbody>
              <strong> NB:une réservation est "Validée" signifie validée par le client mais n'est pas encore prise en charge </strong>
              </table>

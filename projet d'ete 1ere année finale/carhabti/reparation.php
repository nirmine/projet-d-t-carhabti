        ...
        <h3><i class="fa fa-angle-right"></i> Ajouter une Véhicule à réparer</h3>
          ...
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form  action="reparation1.php" method="POST"  name="form1" onsubmit="javascript:return reparer(form1.sr,form1.enreg);" >
                <div class="form-group">

                    <div>
                        <input type="text" name="sr" id="sr" class="form-control round-form" placeholder="Série" maxlength="3" required> 
                    </div>
                    <div>
                        <input type="text" name="enreg" id="enreg" class="form-control round-form" placeholder="Enregistrement" maxlength="4" required> 
                    </div>
                  
                    <div>
                        <input type="text" name="mod" id="mod" class="form-control round-form" placeholder="Modèle" required> 
                    </div>
                    ...
                    <div>
                        <input type="text" name="piece" id="piece" class="form-control round-form" placeholder="Nom de la pièce" required>
                    </div>
...
<footer class="site-footer" style="margin-top:60px">
  <div class="text-center">
    ...
    <a href="reparation.php#" class="go-top">

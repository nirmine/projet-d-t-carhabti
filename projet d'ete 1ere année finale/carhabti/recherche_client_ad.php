...
<head>
  ...
  <title>CarHabti-Recherche client</title>
...
<body>
  <section id="container">
    ...
    <div class="row mt" style="height:640px">
          <div class="col-lg-12">
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Rechercher un client </h4>
                 <form name="rechercheClient" method="POST"  action="rechercheClient_ad.php" >           
                    <div class="form-group"> 
                          
                           <select class="form-control round-form" name="critere" id="critere" required>
                              <option>cin</option>
                              <option>Numéro du Permis</option>
                              <option>nom</option>
                        ...
                        <input type="text" name="choix" name="choix" class="form-control round-form" required> <br>
                       
                            <div>
                                 <input type="submit" value="rechercher" name="boutRecherClient" class="btn btn-round btn-success"> 
                            </div>
                    </div>
                        </form>
            </div>
...
<footer class="site-footer" >
  <div class="text-center">
    ...
    <a href="recherche_client_ad#" class="go-top">

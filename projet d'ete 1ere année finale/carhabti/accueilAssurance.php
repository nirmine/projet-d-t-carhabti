<?php
      function afficheAssurance($utilisateur)
      {
          try {
              $db = new PDO(
                ...
                echo "
                            ...
                            <div class=\"thumbnail\">
                              ...
                              <div class=\"caption\">
                                ...
                                <p> Renouvellement de l'assurance .</p>
                                <p><a href=\"assurance1.php?num=".$e['numero_vehicule']." \"  class=\"btn btn-primary\" role=\"button\">Mettre à jour </a></p>
                              </div>
                            </div>
                          </div>
                            ";
            ...
            else 
            {
              ...
              <div class=\"thumbnail\">
                ...
                <div class=\"caption\">
                  <h3>". $e['serie'] .' TU '. $e['enregistrement'] ."</h3>
                  <p> Renouvellement de l'assurance .</p>
                  <p><a href=\"assurance1_ad.php?num=".$e['numero_vehicule']." \"  class=\"btn btn-primary\" role=\"button\">Mettre à jour </a></p>
                </div>
              </div>
            </div>
              ";

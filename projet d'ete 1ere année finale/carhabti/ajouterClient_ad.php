     ...
     <section id="main-content">
        <section class="wrapper site-min-height">
          ...
          <div class="row mt">
            <div class="col-lg-12">
              <div class="col-lg-12">
                <h4><i class="fa fa-angle-right"></i>ajouter client</h4>
                <div class="form-panel">
                  <div class=" form">
                    <form class="cmxform form-horizontal style-form" action="ajouterClient1_ad.php" name="form4" id="commentForm" method="POST" onsubmit="javascript: return ajout_client(document.form4.cin,document.form4.numPermis,document.form4.tel,document.form4.mail);" >

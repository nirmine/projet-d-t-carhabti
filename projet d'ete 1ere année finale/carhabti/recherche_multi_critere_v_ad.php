  ...
  <section id="container">
    ...
    <h3><i class="fa fa-angle-right"></i> Recherche Multi Critère</h3>
       ...
       <div class="col-lg-12">
         <div class="form-panel">
           ...
           <form  action="recherche_ad.php" method="POST"  name="form1" >
           ...
           <div class="form-group">
               <label for="rech" class="sr-only">Choisissez le critère de recherche </label>
                 <select name="rech" id="rech" class="form-control round-form">
                     ...
                     <option value="immatriculation">Série d'immatriculation</option>
              ...
              <div class="form-group">
                 ...
                 <div class="col-sm-10"> 
                     <input type="text" name="mark" class="form-control round-form" required> 
                 </div>
              </div>
              <div>
    ...
    <footer class="site-footer" >
      <div class="text-center">
        ...
        <a href="recherche_multi_critere_v_ad.php#" class="go-top">
